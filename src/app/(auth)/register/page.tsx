...
export default function RegisterPage() {
  ...
  return (
    <div
      className={`min-h-screen flex flex-col items-center justify-center px-6 py-12 relative overflow-hidden transition-colors duration-500 ${
    ...
    >
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          >
            Kreiraj nalog i otkrij najbolje smestaje
          </p>
        </div>
